...
const ambienteLista = {
  ...
  EPR: [1.15, 1.12, 1.08, 1.04, 0.96, 0.91, 0.87, 0.82, 0.76,]
}
...
const indice = retornaOPrimeiroValorMaior(50,correcaoTemp.ambiente.temperatura);

const listaArmazenada = correcaoTemp.ambiente.PVC;
console.log(listaArmazenada[indice]);
*/
function correcaoDeTemperatura (temp,local,isolante)  {
